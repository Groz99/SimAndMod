...
%This version uses GQ and quadratic basis functions to improve on the
%flexibility and performance of the previous solver

%E.g.
%[C, Domain, TDomain] = SolveLaplaceTransient_GQ(1,-9,4,100,'DL',0,'DL',1,'CN');

 
function [C, Domain, TDomain] = SolveLaplaceTransient_GQ(D,Lamda,NElements,NTsteps,BC0,BC0Val,BC1,BC1Val,DM)
...
% Initialise mesh for quadratic basis functions
...
for idxt = 1 : NTsteps
    ...
    Fnext = GlobalSourceGQ(SourceVector,Mesh);   
