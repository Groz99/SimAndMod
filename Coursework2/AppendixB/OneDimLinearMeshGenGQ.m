...
%This version has been modified to be suitable for quadratic basis
%functions


function [mesh] = OneDimLinearMeshGenGQ(xmin,xmax,Ne)
    ...
    mesh.nvec = xmin:dx/2:xmax; %needs to halve for internal nodes
